...
let averageDonation = runners.reduce((accumulator, currentValue) => {
  return (accumulator + currentValue.donation / totalRunners);
}, 0);


console.log(averageDonation.toFixed(2));

// Problem 2
// Return Donations over $100

let donationsOver100 = runners.filter(runner => {
...
// Determine how many people with shirt size of XL or Larger donated more than $100 

let xlShirts = runners.filter(runner => {
  return runner.shirt_size.includes("XL") && runner.donation > 100;
});
